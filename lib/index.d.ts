...
export declare function bindAsyncAction<R>(actionCreators: AsyncActionCreators<void, R, any>, mustDispatchStartedAction?: boolean): {
...
export declare function bindAsyncAction<P, R>(actionCreators: AsyncActionCreators<P, R, any>, mustDispatchStartedAction?: boolean): {
